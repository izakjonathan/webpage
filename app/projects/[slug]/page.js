  ...
  return (
    <main className="case-study">
      ...
      <nav className="case-nav">
        <Link href={`/projects/${prevSlug}`}><small>← Previous</small>← {projects[prevSlug].title}</Link>
        <Link href="/projects">All Projects</Link>
        <Link href={`/projects/${nextSlug}`}><small>Next →</small>{projects[nextSlug].title} →</Link>
      </nav>
    </main>
  );
}
