...
export default function ProjectPage({ params }) {
  ...
  return (
    <><header><nav className="nav-inner">Portfolio</nav></header><main className="case-study">
      ...
      <nav className="case-nav">
        <Link href={`/projects/${prevSlug}`}><small>Previous Project</small>Previous Project</Link>
        <Link href="/projects">All Projects</Link>
        <Link href={`/projects/${nextSlug}`}><small>Next Project</small>Next Project</Link>
      </nav>
    </main><footer className="footer-inner">© Izak Hyllested</footer></>
  );
}
